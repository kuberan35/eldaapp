  ...
  return (
    <div className="p-20 max-w-4xl mx-auto bg-gray-900 text-gray-400 text-center">
      ...
      <form id="registration-form" onSubmit={handleSubmit} className="space-y-4">
        ...
        <input type="file" id="fileUpload" name="fileUpload" accept="application/pdf,doc," required className="w-full my-2 p-2 border border-gray-400 rounded text-gray-400" />
